...
let toolsKNN = {
    ...
    getInterTrend: function (
      ...
      emaFilter: function (bars, signal) {
        ...
        let ema200 = toolsTA.getEMA(bars.map(b=>b.ClosePrice), 200)
        let ema100 = toolsTA.getEMA(bars.map(b=>b.ClosePrice), 100)
        let ema50 = toolsTA.getEMA(bars.map(b=>b.ClosePrice), 50)
        let ema20 = toolsTA.getEMA(bars.map(b=>b.ClosePrice), 20)
